	...
	public class MovieContext:DbContext
	{
		   ...
		   : base(options)
		{
			if (Database.EnsureCreated())
			{
				...
				{
					Title = "Отступники",
					TitleEng = "The Departed",
					Genre = "Триллер, Драма, Криминальный",
					...
					"получают каждый от своего начальства наказ найти и обезвредить друг друга.",
					Poster = "/img/dep.jpg"
				});
				Movies?.Add(new Movie
				{
					Title = "Талантливый мистер Рипли",
					TitleEng = "The Talented Mr. Ripley",
					Genre = "Детектив, Триллер, Драма",
					Director = "Энтони Мингелла",
					Year = 1999,
					Description = "После случайного знакомства один из богатейших людей Америки дает Тому Рипли поручение съездить в Италию и убедить его сына, транжирящего деньги в Европе, вернуться в Штаты. Вскоре Том уже знакомится с Дики Гринлифом и Мардж. " +
					"Их роскошная жизнь очаровывает Тома, и он решает занять место Дики.",
					Poster = "/img/riply.jpg"
				});
				Movies?.Add(new Movie
				{
					Title = "Аватар",
					TitleEng = "Avatar",
					Genre = "Приключение, Фантастика",
				...
				Movies?.Add(new Movie
				{
					...
					"Ему помогает посланник высшего разума — хрупкая на вид девушка Лилу.",
					Poster = "/img/5elem.jpg"
				});
				Movies?.Add(new Movie
				{
